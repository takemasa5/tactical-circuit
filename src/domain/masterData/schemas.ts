...
const engineSchema = definitionSchema(
  {
    ...
    forwardPrepareTicks: nonNegativeInt32,
    forwardRecoveryTicks: nonNegativeInt32,
    backwardPrepareTicks: nonNegativeInt32,
    backwardRecoveryTicks: nonNegativeInt32,
    strafePrepareTicks: nonNegativeInt32,
    strafeRecoveryTicks: nonNegativeInt32,
    turnPrepareTicks: nonNegativeInt32,
    turnRecoveryTicks: nonNegativeInt32,
    blockedCancelTicks: nonNegativeInt32,
    energyConsumption: nonNegativeInt32,
    weight: nonNegativeInt32,
  },
  [
