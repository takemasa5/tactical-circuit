...
本書は`docs/planning/milestones/mvp.md`のPhase 2で実装するプログラムエディタの範囲と完了条件を定義する。
...
Program Validator連携はPhase 3で実装する。検索の将来仕様は`docs/specs/planned/editor_search.md`で定義する。
